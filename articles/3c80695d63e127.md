...
そうです．今回の実装ではURLのパラメーターとして `id` が送られてくるのですが...
（/users/details/{id} など）
<br>
...
今回の記事で使ったコードの完全版として，Docker なども使用して実際に Iris が使える参考用リポジトリがこちらにありますので，気になる方是非お使いください．

https://github.com/mkosakana/go-iris-sample
